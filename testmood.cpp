...
void TestMood::on_buttonNextQuestion_5_clicked()
{
    ...
    if (check)
    {
        QPixmap backgroundImage("/home/nastya/Загрузки/emoutions.jpg"); // путь к изображению
        ui->PictureForTest->setPixmap(backgroundImage.scaled(ui->PictureForTest->size(), Qt::IgnoreAspectRatio));
...
void TestMood::on_buttonNextQuestion_6_clicked()
{
    ...
    if (check)
    {
        QPixmap backgroundImage("/home/nastya/Загрузки/flower.jpg"); // путь к изображению
        ui->PictureForTest->setPixmap(backgroundImage.scaled(ui->PictureForTest->size(), Qt::IgnoreAspectRatio));
...
void TestMood::on_buttonNextQuestion_7_clicked()
{
    ...
    if (check)
    {
        QPixmap backgroundImage("/home/nastya/Загрузки/body.jpg"); // путь к изображению
        ui->PictureForTest->setPixmap(backgroundImage.scaled(ui->PictureForTest->size(), Qt::IgnoreAspectRatio));
...
void TestMood::on_buttonNextQuestion_8_clicked()
{
    ...
    if (check)
    {
        QPixmap backgroundImage("/home/nastya/Загрузки/eat.jpg"); // путь к изображению
        ui->PictureForTest->setPixmap(backgroundImage.scaled(ui->PictureForTest->size(), Qt::IgnoreAspectRatio));
...
void TestMood::on_buttonNextQuestion_9_clicked()
{
    ...
    if (check)
    {
        QPixmap backgroundImage("/home/nastya/Загрузки/present.jpg"); // путь к изображению
        ui->PictureForTest->setPixmap(backgroundImage.scaled(ui->PictureForTest->size(), Qt::IgnoreAspectRatio));
